<footer class="footer mt-5 py-4 bg-light">
    <div class="container">
        <div class="row">
            <div class="col-md-4 mb-4 mb-md-0">
                <div class="d-flex align-items-center mb-3">
                    <img src="img/logo.png" alt="Encontre e Doe Logo" height="30" class="me-1">
                </div>
                <p class="text-muted">Conectando doadores a quem mais precisa.</p>
            ...
            <div class="col-md-4">
                ...
                <ul class="list-unstyled text-muted">
                    <li><i class="fas fa-envelope me-2"></i> contato@encontreedoe.com.br</li>
        ...
        <div class="text-center text-muted">
            <small>&copy; <?php echo date('Y'); ?> Encontre e Doe. Todos os direitos reservados.</small>
        </div>
    </div>
</footer>
